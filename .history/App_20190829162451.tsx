  ...
  return (
    <ImageBackground resizeMode='cover' source={bg} style={{ flex: 1 }}>
      ...
      >
        ...
        <View>
          <Text
            style={{ fontFamily: 'semibold', color: 'white', fontSize: scale(14) }}
          >
            Kementrian Perhubungan
          </Text>
          <Text
            style={{ fontFamily: 'bold', color: 'white', fontSize: scale(10) }}
          >
            Direktorat Jendral Perhubungan Laut
          </Text>
          <Text
            style={{ fontFamily: 'bold', color: 'white', fontSize: scale(14) }}
          >
            Kementrian Perhubungan
          </Text>
        </View>
